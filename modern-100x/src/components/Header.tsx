...
const Header = () => (
  <header className="w-full flex items-center justify-between px-12 py-4 bg-white dark:bg-[#18181b] shadow-sm fixed top-0 left-0 z-50 h-[72px]">
    ...
    <nav className="hidden md:flex gap-8 text-base font-medium text-[#222] dark:text-[#bdbdbd]">
    ...
    <div className="flex items-center gap-3">
      <button
        ...
        className="text-2xl px-2 py-1 rounded hover:bg-gray-100 dark:hover:bg-[#232326] transition"
      >
