    ...
    <div className="relative z-10 w-full flex flex-col items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl w-full">
        {features.map((feature, idx) => (
          <div key={idx} className="bg-[#18181b] dark:bg-[#232326] rounded-xl p-8 text-white text-lg font-semibold text-center shadow-md border border-[#232326] dark:border-[#232326] flex items-center justify-center gap-4">
