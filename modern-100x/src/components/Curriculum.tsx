...
const CurriculumTimeline = () => {
  ...
  return (
    <section id="curriculum" className="relative w-full py-8 px-4 flex flex-col items-center fade-in overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-4xl mx-auto flex flex-col items-start md:items-start">
        <h2 className="text-3xl md:text-4xl font-bold text-left md:text-left text-black dark:text-white mb-2" style={{ fontFamily: "'SF Pro Display', 'SF Pro', sans-serif" }}>What Will You <span className="bg-gradient-to-r from-blue-500 via-pink-500 to-orange-500 bg-clip-text text-transparent">Learn?</span></h2>
        <p className="text-lg text-gray-700 dark:text-gray-300 text-left md:text-left mb-10">The most beginner-friendly curriculum in Generative AI. Zero to Pro in 3 months.</p>
